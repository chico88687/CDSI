...
//-----------------------------------------------
@View(members = "Identificação [" + " entidade,existecrm;" + " nome;" + " datanascimento, genero, classenacionalidade;"
		+ " telefone, email;" + " nif, cartaocidadao, passaporte;" + " classeestadoentidade, dataestadoentidade;" + "]"
		+ "Morada {" + " morada;" + " codigopostal;" + "};" + "Perfil Crédito {" + " classesegmentocliente;"
		+ " entidadeempregadora,datainicioemprego;" + " classesectoractividade,classesituacaoprofissional;"
		+ " salarioanual, creditosactuais;" + " listanegra,rating;" + "};" + "Logging {" + " datalog;"
		+ " utilizadorlog;" + " estadolog;" + "}")

//-----------------------------------------------
//Modelização interface com utilizador LIST
//-----------------------------------------------
@Tab(properties = "nome,nif,telefone,email,salarioanual", defaultOrder = "${nome} desc, ${salarioanual} asc")
...
public class EN_Entidade {
	...
	@DescriptionsList(descriptionProperties = "descricao", condition = "${estadolog} = 'A'")
	...
	public void setNome(String ynome) {
		if (Utilitarios.CampoStringValido(ynome, 10) == false) {
			throw new javax.validation.ValidationException(XavaResources.getString("Nome: Valor incorreto ", ynome));
		}
		this.nome = ynome;
	}
	...
	public void setNif(String ynif) {
		if (Utilitarios.CampoNifValido(ynif) == false) {
			throw new javax.validation.ValidationException(XavaResources.getString("NIF: Valor incorreto ", ynif));
		}
		this.nif = ynif;
	}
	...
	public void setCartaocidadao(String ycartaocidadao) {
		if (Utilitarios.CampoCartaoCidadaoValido(ycartaocidadao) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Cartão Cidadão: Valor incorreto ", ycartaocidadao));
		}
	...
	public void setPassaporte(String ypassaporte) {
		if (Utilitarios.CampoPassaporteValido(ypassaporte) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Passaporte: Valor incorreto ", ypassaporte));
		}
	...
	public void setDatainicioemprego(LocalDate ydatainicioemprego) {
		if (ydatainicioemprego.isAfter(LocalDate.now())) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Data Inicio Emprego: Valor incorreto ", ydatainicioemprego));
		}
	...
	public void setMorada(String ymorada) {
		if (Utilitarios.CampoStringValido(ymorada, 15) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Morada: Valor incorreto ", ymorada));
		}
		this.morada = ymorada;
	}
	...
	public void setEmail(String yemail) {
		if (Utilitarios.CampoEmailValido(yemail) == false) {
			throw new javax.validation.ValidationException(XavaResources.getString("Email: Valor incorreto ", yemail));
		}
		this.email = yemail;
	}
	...
	public void setTelefone(String ytelefone) {
		if (Utilitarios.CampoTelefoneValido(ytelefone) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Telefone: Valor incorreto ", ytelefone));
		}
	...
	public void setCodigopostal(String ycodigopostal) {
		if (Utilitarios.CampoCodigoPostalValido(ycodigopostal) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Código Postal: Valor incorreto ", ycodigopostal));
		}
	...
	public void setDatanascimento(LocalDate ydatanascimento) {
		if ((ydatanascimento.getYear() - LocalDate.now().getYear()) < 19) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Data Nascimento: Valor incorreto ", ydatanascimento));
		}
	...
	public void setGenero(String ygenero) {
		if (Utilitarios.CampoGeneroValido(ygenero) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Género: Valor incorreto ", ygenero));
		}
		this.genero = ygenero;
	}
	...
	public void setEntidadeempregadora(String yentidadeempregadora) {
		if (Utilitarios.CampoStringValido(yentidadeempregadora, 15) == false) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Entidade Empregadora: Valor incorreto ", yentidadeempregadora));
		}
	...
	public void setRating(int yrating) {
		if (yrating > 5) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Rating: Valor incorreto ", yrating));
		}
		this.rating = yrating;
	}
	...
	public void setSalarioanual(double ysalarioanual) {
		if (ysalarioanual < 40000) {
			throw new javax.validation.ValidationException(
					XavaResources.getString("Salário Anual: Valor incorreto ", ysalarioanual));
		}
